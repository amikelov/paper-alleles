...
g1<-comparisonStats %>%
    ...
    theme_bw()+
   labs(y="Fraction of alleles\nsupported by long reads",x = "Mean SHM level in a sample")
...
g3<-comparisonStats  %>% 
 ...
 # geom_point(position = position_dodge(width=0.75))+
  ...
  theme_bw()+
  labs(y="Fraction of alleles supported by long reads")
...
```{r}
plot_grid(plot_grid(g1,g2,nrow = 2),plot_grid(g3,g4,ncol = 2),nrow=2,rel_heights = c(1,0.5))
```
